...
public class RecordHelper {
    ...
    public JSONObject create(Record r) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `sa_project`.`record`(`patient_id`,`symptoms`, `days`, `degree`, `Medicine_id`, `note`, `visit_date`, `doctor`,`edited_by`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            String visite_date = r.getVisite_date();
    ...
    public JSONObject update(Record r) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa_project`.`record` SET `symptoms` = ? ,`days` = ? ,`degree` = ? ,`Medicine_id` = ? ,`note` = ? ,`visit_date` = ? , `doctor` = ?,`edited_by` = ?  WHERE `id` = ?";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String visite_date = rs.getString("visite_date");
    ...
    public JSONObject getById(String record_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`record` WHERE `id` = ?";
